...
From 	: Kansul Mahrifa(B13123)						Lab partners : Ahmed Karanath(B13104)
...
LED_var1.js	-The top LED turns on with either switch is pressed.Both LEDs light we both switched are pressed.
LED_var2.js	-Pressing one switch blinks an LED 10 times and then stops.
LED_var3.js	-Pressing one switch starts an LED blinking.Pressing another switch stops the LED from blinking.
